...
(() => {
            ...
            9649: (t, e, r) => {
                ...
                function o() {
                    ...
                    function L(t, e) {
                        var r = e.method,
                            n = t.iterator[r];
                        if (void 0 === n) return e.delegate = null, "throw" === r && t.iterator.return && (e.method = "return", e.arg = void 0, L(t, e), "throw" === e.method) || "return" !== r && (e.method = "throw", e.arg = new TypeError("The iterator does not provide a '" + r + "' method")), d;
                    ...
                    return v.prototype = m, a(x, "constructor", {
                        value: m,
                        configurable: !0
                    }), a(m, "constructor", {
                        value: v,
                        configurable: !0
                    }), v.displayName = f(m, l, "GeneratorFunction"), e.isGeneratorFunction = function(t) {
                        var e = "function" == typeof t && t.constructor;
                        return !!e && (e === v || "GeneratorFunction" === (e.displayName || e.name))
                    }, e.mark = function(t) {
                        return Object.setPrototypeOf ? Object.setPrototypeOf(t, m) : (t.__proto__ = m, f(t, l, "GeneratorFunction")), t.prototype = Object.create(x), t
                    }, e.awrap = function(t) {
                        return {
                            __await: t
                        }
                    ...
                    }, O(x), f(x, l, "Generator"), f(x, u, (function() {
                        return this
    ...
    o.m = r, o.n = t => {
    ...
    }, o.f = {}, o.e = t => Promise.all(Object.keys(o.f).reduce(((e, r) => (o.f[r](t, e), e)), [])), o.u = t => (969 === t ? "notes-app" : t) + ".min.js", o.g = function() {
    ...
    }(), o.o = (t, e) => Object.prototype.hasOwnProperty.call(t, e), t = {}, e = "elementor-pro-notes:", o.l = (r, n, i, a) => {
        if (t[r]) t[r].push(n);
        else {
            var c, u;
            if (void 0 !== i)
            ...
            c || (u = !0, (c = document.createElement("script")).charset = "utf-8", c.timeout = 120, o.nc && c.setAttribute("nonce", o.nc), c.setAttribute("data-webpack", e + i), c.src = r), t[r] = [n];
            var p = (e, n) => {
                    c.onerror = c.onload = null, clearTimeout(h);
                    var o = t[r];
                    if (delete t[r], c.parentNode && c.parentNode.removeChild(c), o && o.forEach((t => t(n))), e) return e(n)
                },
        ...
        function u(e) {
            ...
            function r() {
                return (r = (0, e.Z)(a().mark((function e() {
                    var r, i;
                    return a().wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return t = document.createElement("div"), document.body.appendChild(t), e.next = 4, Promise.all([o.e(173), o.e(969)]).then(o.bind(o, 2749));
                            case 4:
                                r = e.sent, i = r.default, ReactDOM.render(n().createElement(i, null), t);
                            case 7:
                            case "end":
                                return e.stop()
                        }
            ...
            window.addEventListener("message", (function(e) {
                var n, o, i, a;
                if (null !== (n = e.data) && void 0 !== n && null !== (o = n.name) && void 0 !== o && o.startsWith("elementor-pro/notes")) {
                    var c = ["e-route-notes"];
                    switch (e.data.name) {
                        case "elementor-pro/notes/open":
                            (i = document.body.classList).add.apply(i, c),
                                function() {
                                    r.apply(this, arguments)
                                }();
                            break;
                        case "elementor-pro/notes/close":
                            (a = document.body.classList).remove.apply(a, c), t && ReactDOM.unmountComponentAtNode(t)
                    }
                }
            })), window.top.postMessage({
                name: "elementor-pro/notes/config",
                payload: u({}, elementorNotesConfig)
            }, "*")
        }()
    })()
})();